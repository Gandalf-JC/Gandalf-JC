...
for ik in range(Numaggs):
    ...
    bvar = 25.0 / 180.0 * np.pi                      # 第一层和第五层允许波动偏大，第二三四层波动应偏小
...
mdb.models[Modelname].materials['aggregate'].Elastic(table=((3.27e4, 0.21),))
...
mdb.models[Modelname].materials['asphalt-mortar'].Density(table=((2.05e-9,),))
mdb.models[Modelname].materials['asphalt-mortar'].Elastic(table=((356, 0.32),))
